...
## Result (catalog-normalized, measured 2026-08-14)

| Document | Words | Raw score | Exempt score | Budget |
|---|---:|---:|---:|---:|
| `README.md` | 4,326 | 64 | **20** | 30 |
| `SKILL.md` | 15,166 | 83 | **76** | 80 |
| `CONTRIBUTING.md` | 648 | 2 | **2** | 15 |
| `detector/README.md` | 593 | 2 | **2** | 15 |
| `detector/CATEGORIES.md` | 1,147 | 1 | **1** | 15 |
| `examples/README.md` | 736 | 2 | **1** | 10 |
| `CHANGELOG.md` | 514 | 1 | **2** | 40 |
| `PROOF.md` | 1,164 | 14 | **13** | 20 |
