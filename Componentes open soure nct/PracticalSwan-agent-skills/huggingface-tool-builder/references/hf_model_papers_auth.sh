...
Examples:
    ...
    # Get papers with authentication after configuring HF_TOKEN in an approved
    # local secret manager or environment (never put its value in this command)
    HF_TOKEN="$HF_TOKEN" $0 your-private-model
