...
# With project tracking; still reads TAVILY_API_KEY from the environment
project_client = TavilyClient(project_id="your-project-id")

# With proxies
proxies = {"http": "<proxy>", "https": "<proxy>"}
proxy_client = TavilyClient(proxies=proxies)
```
...
const projectClient = tavily({
  apiKey,
  projectId: "your-project-id"
});

// With proxies
const proxyClient = tavily({
  apiKey,
  proxies: {
    http: "<proxy>",
    https: "<proxy>"
