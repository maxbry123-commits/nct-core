...
Todo componente preparado para conexiones futuras debe dejar su plugin listo al crearse. Tras registrar, no se edita el archivo para conectarlo; se usa plugin, contrato, extension point, adapter o cable.
