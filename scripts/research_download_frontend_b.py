...
REPOS=[('17','shadcn-ui','https://github.com/shadcn-ui/ui.git'),('20','Vite','https://github.com/vitejs/vite.git'),('21','TypeScript','https://github.com/microsoft/TypeScript.git'),('22','Parcel','https://github.com/parcel-bundler/parcel.git'),('23','Radix-UI','https://github.com/radix-ui/primitives.git'),('24','React-Spectrum','https://github.com/adobe/react-spectrum.git'),('25','Motion','https://github.com/motiondivision/motion.git'),('26','Storybook','https://github.com/storybookjs/storybook.git'),('29','GrapesJS','https://github.com/GrapesJS/grapesjs.git'),('30','Puck','https://github.com/puckeditor/puck.git'),('31','Plasmic','https://github.com/plasmicapp/plasmic.git'),('32','BuilderIO','https://github.com/BuilderIO/builder.git'),('33','Mitosis','https://github.com/BuilderIO/mitosis.git'),('34','TeleportHQ','https://github.com/teleporthq/teleport-code-generators.git'),('35','VvvebJs','https://github.com/givanz/VvvebJs.git'),('36','Bit','https://github.com/teambit/bit.git'),('37','React-Cosmos','https://github.com/react-cosmos/react-cosmos.git'),('38','ToolJet','https://github.com/ToolJet/ToolJet.git')]
